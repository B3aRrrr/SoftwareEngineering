#ifndef HTTPMESSAGESERVER_H
#define HTTPMESSAGESERVER_H
...
class HTTPMessageServer : public Poco::Util::ServerApplication
{
public:
    HTTPMessageServer() : _helpRequested(false)
    {
    }
