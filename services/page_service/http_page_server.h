#ifndef HTTPPAGESERVER_H
#define HTTPPAGESERVER_H
...
class HTTPPageServer : public Poco::Util::ServerApplication
{
public:
    HTTPPageServer() : _helpRequested(false)
    {
    }
